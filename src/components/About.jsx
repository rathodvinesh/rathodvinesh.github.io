      ...
      <section className="py-10 md:py-16">
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="text-center">
            ...
            className="font-medium text-gray-300 text-4xl md:text-3xl lg:text-7xl mb-8 md:mb-24 lg:mb-32">
            ...
            <motion.p 
                ...
                transition={{duration: 1}}
                className="font-normal text-gray-300 text-sm sm:text-sm md:text-sm lg:text-base"
            >
