              ...
              <div className="flex flex-col md:flex-row md:space-x-6">
                ...
                >
                  <h1 className="font-normal text-gray-300 text-3xl md:text-4xl mb-3 flex items-center gap-3 text-left">
                    ...
                    <div className="flex items-center gap-2">
                      <a href="https://github.com/rathodvinesh/Hospital-management-system" target="_blank" rel="noopener noreferrer"
                        className="text-xl text-purple-700 hover:text-purple-500 transition-colors">
                        <BsGithub />
                      </a>
                    </div>
                  ...
                  <h1>
                    <p className="font-normal text-gray-500 text-sm md:text-base">
                      Hospital OPD & Appointment Management System (HAMS) – A scalable ASP.NET Core Web API for managing patient registration, doctor availability, and appointment scheduling with secure role-based access tested via Swagger/Postman with SOLID design and SQL support.
                    </p>
                    <div className="flex flex-wrap items-center justify-start gap-2 mt-2 mb-2">
                      <div className="mr-2 rounded bg-neutral-900 px-2 py-1">
                        <p className="text-purple-700">ASP.NET Core Web API</p>
                      </div>
                      <div className="mr-2 rounded bg-neutral-900 px-2 py-1">
                        <p className="text-purple-700">SQL Server</p>
                      </div>
                      <div className="mr-2 rounded bg-neutral-900 px-2 py-1">
                        <p className="text-purple-700">Swagger/Postman</p>
                      </div>
                      <div className="mr-2 rounded bg-neutral-900 px-2 py-1">
                        <p className="text-purple-700">JWT Authentication</p>
                      </div>
                      <div className="mr-2 rounded bg-neutral-900 px-2 py-1">
                        <p className="text-purple-700">Docker</p>
                      </div>
                    </div>
                  </h1>
