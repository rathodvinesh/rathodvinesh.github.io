      ...
      <section className="py-10 md:py-16">
        <div className="container max-w-screen-xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-gray-900 px-8 py-10 rounded-md">
              <h4 className="font-medium text-gray-300 text-lg mb-4">
                2015 – 2016
              </h4>

              <p className="font-normal text-gray-300 text-md mb-4">
              <b>B.E in Computer Engineering</b>
              <br />
              Vasantdada Patil Pratishthan's College of Engineeringand Visual Arts, Mumbai
              </p>
